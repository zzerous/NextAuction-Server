...
class UploadTest extends Component {
  ...
  uploadContent = async (e) => {
    ...
    const formData = new FormData(); // upload formData
  ...
  const downloadCert = result.data
  ...
  */
  ...
  link.href = href;
  link.download = "UploadResult1MB.json";
  ...
  render(){
    ...
    return (
        ...
        <form className="UploadContent" encType='multipart/fomr-data' method='post' onSubmit={this.uploadContent}>
        <Dropdown 
